...
export const api={
  ...
  ,transitionSyncTask:(id,version,data)=>request(`/api/v1/sync-tasks/${id}/transitions`,{method:'POST',headers:{'Idempotency-Key':idempotencyKey(),'If-Match':String(version)},body:JSON.stringify(data)})
