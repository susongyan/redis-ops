...
public interface JobMapper {
    @Insert("""
        ...
        """)
    @Options(useGeneratedKeys=true,keyProperty="id") void insert(JobRow row);
    ...
    class JobRow { public Long id;public String jobType;public long bizId;public String payload,idempotencyKey; }
}
