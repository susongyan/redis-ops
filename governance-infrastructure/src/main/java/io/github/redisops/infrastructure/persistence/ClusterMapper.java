...
public interface ClusterMapper {
    ...
    class ClusterRow {
        public Long id; public String name; public String environment; public String businessLine;
        public String owner; public String opsOwner; public String serviceLevel; public String mode;
        public String redisVersion; public String endpoint; public Long idcId;
        public String status;
        static ClusterRow from(RedisCluster c) {
            ClusterRow r = new ClusterRow(); r.id=c.id(); r.name=c.name(); r.environment=c.environment();
            r.businessLine=c.businessLine(); r.owner=c.owner(); r.opsOwner=c.opsOwner(); r.serviceLevel=c.serviceLevel();
            r.mode=c.mode().name(); r.redisVersion=c.redisVersion(); r.endpoint=c.endpoint();
            r.idcId=c.idcId(); r.status=c.status().name(); return r;
        }
    }
}
