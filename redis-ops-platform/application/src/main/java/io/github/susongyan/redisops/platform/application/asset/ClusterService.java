...
public class ClusterService {
    ...
    private final io.github.susongyan.redisops.platform.domain.location.LocationRepository locations;
    ...
    public ClusterService(ClusterRepository clusters, AuditRepository audits,
            io.github.susongyan.redisops.platform.domain.location.LocationRepository locations,
    ...
    private void validateIdc(Long idcId) {
        ...
        if (idc.status() != io.github.susongyan.redisops.platform.domain.location.ResourceStatus.ACTIVE)
