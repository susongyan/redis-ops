...
import io.github.redisops.platform.domain.asset.ClusterMode;
import io.github.redisops.platform.domain.asset.ClusterRepository;
import io.github.redisops.platform.domain.asset.RedisConnectionProfile;
import io.github.redisops.platform.domain.asset.RedisConnectionProfileProvider;
import io.github.redisops.platform.domain.asset.RedisConnectionTestPort;
import io.github.redisops.platform.domain.asset.RedisConnectionTestResult;
...
class RedisConnectionTestServiceTest {
    ...
    void editCanReuseSavedPassword() {
        ...
        when(clusters.findById(7)).thenReturn(Optional.of(new io.github.redisops.platform.domain.asset.RedisCluster(
                7L, "cluster", "prod", null, "owner", null, null, ClusterMode.STANDALONE,
                "7.2", "old:6379", 1L, io.github.redisops.platform.domain.asset.ClusterStatus.ACTIVE,
