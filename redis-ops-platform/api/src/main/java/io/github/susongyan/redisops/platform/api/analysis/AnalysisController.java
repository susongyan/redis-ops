...
public class AnalysisController {
    ...
    private final io.github.susongyan.redisops.platform.application.IdempotencyService idempotency;

    public AnalysisController(AnalysisService service,
            io.github.susongyan.redisops.platform.application.IdempotencyService idempotency) {
