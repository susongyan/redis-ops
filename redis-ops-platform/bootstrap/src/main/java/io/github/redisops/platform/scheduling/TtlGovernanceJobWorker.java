...
import io.github.redisops.platform.application.governance.TtlGovernanceService;
...
public class TtlGovernanceJobWorker {
    ...
    private void execute(long id, boolean apply) {
        ...
        var probe = new io.github.redisops.platform.domain.validation.ValidationTask(null, "ttl-probe", null,
                task.clusterId(),
