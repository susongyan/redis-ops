...
import io.github.redisops.platform.application.governance.CleanupGovernanceService;
import io.github.redisops.platform.domain.governance.*;
import io.github.redisops.platform.domain.job.*;
import io.github.redisops.platform.domain.validation.*;
...
public class CleanupGovernanceJobWorker {
    ...
    private void execute(long id, boolean apply) {
        ...
        var probe = new io.github.redisops.platform.domain.validation.ValidationTask(null, "cleanup-probe", null,
