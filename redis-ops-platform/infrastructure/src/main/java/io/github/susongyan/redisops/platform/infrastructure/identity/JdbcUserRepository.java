package io.github.susongyan.redisops.platform.infrastructure.identity;
...
public class JdbcUserRepository implements UserRepository {
    public io.github.susongyan.redisops.platform.common.PageResult<Account> list(int page, int size) {
        var items = jdbc.query(
                ...
                size, (page - 1) * size);
        return new io.github.susongyan.redisops.platform.common.PageResult<>(items,
