...
public interface OperationMapper {
    ...
    @Select("SELECT id FROM redis_operation WHERE operation_no=#{number}")
    Long findIdByNumber(String number);
    ...
    class CommandRow {
        public String commandName, category, accessMode, parameterSchemaJson, routingPolicy, nodeKind;
