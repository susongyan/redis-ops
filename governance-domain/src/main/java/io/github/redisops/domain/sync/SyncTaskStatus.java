...
public enum SyncTaskStatus {
    ...
    private static final Map<SyncTaskStatus, Set<SyncTaskStatus>> TRANSITIONS = Map.ofEntries(
            ...
            Map.entry(STARTING, EnumSet.of(FULL_SYNCING, INCR_SYNCING, BLOCKED, FAILED, CANCELLED)),
            Map.entry(FULL_SYNCING, EnumSet.of(INCR_SYNCING, PAUSING, BLOCKED, FAILED, CANCELLED)),
            Map.entry(INCR_SYNCING, EnumSet.of(CAUGHT_UP, PAUSING, STOPPING, BLOCKED, FAILED, CANCELLED)),
            Map.entry(CAUGHT_UP, EnumSet.of(INCR_SYNCING, PAUSING, STOPPING, BLOCKED, FAILED, CANCELLED)),
