...
class RedisClusterTest {
    @Test void requiresEndpoint() {
        BusinessException error=assertThrows(BusinessException.class,()->new RedisCluster(null,"orders","prod",null,
                "owner",null,null,ClusterMode.CLUSTER,null," ",null,null,0,null,null));
        assertEquals("INVALID_ARGUMENT",error.code());
    }
    @Test void defaultsStatusToActive() {
