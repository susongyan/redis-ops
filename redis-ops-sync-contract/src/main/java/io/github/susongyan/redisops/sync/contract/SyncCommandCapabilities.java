...
public final class SyncCommandCapabilities {
    private static final Set<String> SINGLE_KEY = Set.of("SET", "SETEX", "PSETEX", "SETNX", "APPEND", "GETSET",
            "INCR", "DECR", "INCRBY", "DECRBY", "INCRBYFLOAT", "HSET", "HMSET", "HSETNX", "HDEL",
            "HINCRBY", "HINCRBYFLOAT", "LPUSH", "RPUSH", "LPOP", "RPOP", "LSET", "LTRIM", "LREM",
            "LINSERT", "SADD", "SREM", "ZADD", "ZREM", "ZINCRBY", "ZREMRANGEBYRANK", "ZREMRANGEBYSCORE",
            "ZREMRANGEBYLEX", "EXPIRE", "PEXPIRE", "EXPIREAT", "PEXPIREAT", "PERSIST", "SETBIT", "BITFIELD",
            "PFADD", "XADD", "XACK", "XDEL", "XTRIM", "XSETID", "XGROUP", "RESTORE");
    private static final Set<String> SAFE_SPLIT = Set.of("MSET", "DEL", "UNLINK");
    private static final Set<String> HARD_BLOCKED = Set.of("MSETNX", "RENAME", "RENAMENX", "BITOP",
    ...
    public static List<SyncCommandCapability> all(boolean clusterTarget, SyncCommandPolicy policy) {
        ...
        result.sort(
                Comparator.comparing(SyncCommandCapability::category).thenComparing(SyncCommandCapability::command));
