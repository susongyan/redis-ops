...
public interface WorkerSyncMapper {
    ...
    @Insert("""
            ...
            """)
    void upsertChannel(io.github.redisops.worker.domain.WorkerSyncChannelCheckpoint checkpoint);
    ...
    @Insert("""
            ...
            """)
    void insertMetric(io.github.redisops.worker.domain.WorkerSyncMetricSnapshot metric);
    ...
    @Insert("""
            ...
            """)
    void upsertFullProgress(io.github.redisops.worker.domain.WorkerSyncFullProgress progress);
