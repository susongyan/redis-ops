...
import io.github.susongyan.redisops.worker.domain.WorkerSyncPrecheckReport;
...
public interface WorkerSyncMapper {
    ...
    @Insert("""
            ...
            """)
    void upsertChannel(io.github.susongyan.redisops.worker.domain.WorkerSyncChannelCheckpoint checkpoint);
    ...
    @Insert("""
            ...
            """)
    void insertMetric(io.github.susongyan.redisops.worker.domain.WorkerSyncMetricSnapshot metric);
    ...
    @Insert("""
            ...
            """)
    void upsertFullProgress(io.github.susongyan.redisops.worker.domain.WorkerSyncFullProgress progress);
